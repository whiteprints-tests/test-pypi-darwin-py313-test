...
project = "test pypi darwin py313-test"
...
release = metadata.version("test_pypi_darwin_py313_test")
...
html_theme_options = {
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/whiteprints-tests/test-pypi-darwin-py313-test",
            "icon": "fa-brands fa-square-github",
            "type": "fontawesome",
        },
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/test-pypi-darwin-py313-test",
