...
```console
gh attestation verify <path_to_the_release_artifact> --repo whiteprints-tests/test-pypi-darwin-py313-test
```
...
cosign verify-blob \
    ...
    --certificate-identity-regexp="^https://github.com/whiteprints-tests/test-pypi-darwin-py313-test/.github/workflows/upload_artifacts.yml?" \
