...
# test pypi darwin py313-test

![test pypi darwin py313-test banner](docs/_static/banner.svg)
<div align="center">
    <p>
        <em>
            A Python package.
    ...
    <p>
        <a href="https://www.python.org"><img alt="PyPI - Python Version" src="https://img.shields.io/pypi/pyversions/test-pypi-darwin-py313-test.svg?logo=Python&logoColor=ffd43b"/></a>
        <a href="https://pypi.org/project/test-pypi-darwin-py313-test"><img alt="PyPI - Project Version" src="https://img.shields.io/pypi/v/test-pypi-darwin-py313-test.svg?logo=PyPI&logoColor=ffd43b"/></a>
        ...
        <a href="https://github.com/whiteprints-tests/test-pypi-darwin-py313-test/discussions"><img alt="GitHub Discussions" src="https://img.shields.io/github/discussions/whiteprints-tests/test-pypi-darwin-py313-test.svg?logo=GitHub"></a>
