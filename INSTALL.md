...
```console
pip install test-pypi-darwin-py313-test
```
...
```console
pip install git+ssh://git@github.com/whiteprints-tests/test-pypi-darwin-py313-test
```
...
[package]: https://pypi.org/project/test-pypi-darwin-py313-test
